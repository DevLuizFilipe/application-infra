...
module "vpc" {
  ...
  vpc_subnet_private_cidr_block_base       = "10.100.100.0/24"
  vpc_subnet_private_cidr_block_bits       = "24"
  vpc_subnet_public_cidr_block_base        = "10.100.200.0/24"
  vpc_subnet_public_cidr_block_bits        = "24"
