...
module "vpc" {
  ...
  vpc_subnet_private_cidr_block_base       = "10.50.10.0/16"
  vpc_subnet_private_cidr_block_bits       = "16"
  vpc_subnet_public_cidr_block_base        = "10.50.20.0/16"
  vpc_subnet_public_cidr_block_bits        = "16"
